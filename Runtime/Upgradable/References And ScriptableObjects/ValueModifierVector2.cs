...
namespace SharedValues.Upgradable
{
    ...
    public class ValueModifierVector2 : ValueModifierFloat
    {
        ...
        [SerializeField] Vector2Value vectorVariableToModify = Vector2Value.Magnitude;
